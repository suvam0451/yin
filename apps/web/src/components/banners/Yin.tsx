  ...
  return <div style={{
    ...
    <div style={{display: "flex", flex: 1, flexGrow: 1, flexDirection: "column", alignItems: "center",}}>
      <div
        ...
        <Image style={{
          borderRadius: "50%"
        }} src={`/assets/avatars/yin.jpg`} alt={"yin pfp"} width="128" height="128"/>
      </div>
      ...
      <Text className={"darkmode_text_normal"}
        ...
        >personas</Text>{" "}
        <p style={{color: "#ad88c6", display: "inline", opacity: 0.5}}>&#9670;</p>
      ...
      <Box style={{display: "flex"}}>
        ...
        <Button colorScheme={"purple"} variant={"outline"} fontWeight={800} ml={"0.5rem"}>SEE FEATURES</Button>
      </Box>
    </div>
